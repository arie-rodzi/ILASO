# ============================================================
# ILASO Premium 6-File System — Config + Premium Styles
# ============================================================
...
.ilaso-kicker{letter-spacing:.18em; text-transform:uppercase; color:#F5D27A; font-weight:900; font-size:13px;}
.ilaso-title{font-size:56px; line-height:1; font-weight:1000; margin-top:8px;}
.ilaso-subtitle{font-size:19px; color:#E8EEF9; margin-top:12px; max-width:820px;}
.ilaso-tag-row{display:flex; gap:10px; flex-wrap:wrap; margin-top:22px;}
.ilaso-tag{background:rgba(245,210,122,.13); border:1px solid rgba(245,210,122,.48); color:#FFE8A6; padding:10px 16px; border-radius:999px; font-weight:850; font-size:13px;}
