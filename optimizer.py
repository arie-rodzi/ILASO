# ============================================================
# ILASO Premium 6-File System — Fair KS Optimizer + Output Builder
# ============================================================
import pandas as pd
...
from data_utils import get_pref_score, get_pref_label, is_available_for_class
...
def solve_allocation(dfc, dfl, pref):
    ...
    prob = pl.LpProblem("ILASO_Premium_Fair_KS", pl.LpMinimize)
